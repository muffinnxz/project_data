...
$mem_id = mysqli_real_escape_string($condb,$_POST["mem_id"]);
	...
	echo "window.location = 'mem_edit.php?mem_username=$mem_username&&mem_edit=mem_edit'; ";
	echo "</script>";
	}else{
	echo "<script type='text/javascript'>";
	echo "window.location = 'mem_edit.php?mem_username=$mem_username&&mem_edit_error=mem_edit_error'; ";
	echo "</script>";
	}
...
$mem_username  = mysqli_real_escape_string($condb,$_GET["mem_username"]);
	$sql = "DELETE FROM tbl_member WHERE mem_username=$mem_username";
	$result_del = mysqli_query($condb, $sql) or die ("Error Query: $sql_del " . mysqli_error());	
	mysqli_close($condb);
	...
	echo "<script type='text/javascript'>";
	echo "window.location = 'list_mem.php?mem_no=mem_del';";
	echo "</script>";
